...
SHOTS: list[ShotSpec] = [
    (
        ...
        "Калории, БЖУ и приемы пищи в одном месте",
        ("сумма дня", "БЖУ", "без регистрации"),
    ),
    (
        "02-result",
        ...
        ("по фото", "порции можно поправить"),
    ),
    (
        "03-scan",
        "screenshot-03-scan.png",
        "Сфотографируй еду",
        "Выбери снимок блюда и получи расчет КБЖУ",
        ("камера", "галерея", "AI"),
    ),
    (
        "04-free",
    ...
    (
        ...
        "Смотри динамику калорий и возвращайся к дневнику",
        ("неделя", "калории", "прогресс"),
    ),
]
